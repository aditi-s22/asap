      ...
      <div className="flex-1 grid md:grid-cols-2">
        ...
        <div className="flex items-center justify-center p-6 md:p-12">
          <div className="w-full max-w-sm">
            ...
            <p className="text-slate-500 mt-1.5 text-sm">Log in to manage your bookings and saved spots.</p>
              ...
              <form onSubmit={handleLogin} className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-1.5">
                  <Input
                    ...
                    disabled={isLoading}
                  />
                  <Link to="#" onClick={(e) => { e.preventDefault(); alert("Mock: Forgot Password link clicked."); }} className="text-xs text-accent-600 hover:underline self-end mt-1">
                    Forgot password?
                  </Link>
                </div>
            ...
            <p className="text-center text-sm text-slate-500 mt-8">
              Don't have an account? <Link to="/signup" className="text-parking-600 hover:underline font-medium">Sign Up</Link>
            </p>
          </div>
        </div>
        ...
        <div className="hidden md:flex relative bg-slate-100 items-center justify-center overflow-hidden">
          <img
            src="https://images.unsplash.com/photo-1506521781263-d8422e82f27a?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=60"
            alt="City street with parking"
            className="absolute inset-0 w-full h-full object-cover"
          />
          <div className="absolute inset-0 bg-slate-900/30" />
          <div className="relative z-10 text-white text-center px-10">
            <span className="material-symbols-outlined text-5xl">local_parking</span>
            <p className="mt-4 text-lg font-medium max-w-xs mx-auto">Find and book verified parking spots, wherever you're headed.</p>
          </div>
        </div>
      </div>
    </div>
